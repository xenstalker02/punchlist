...
- Keep the exact spacing scale: 4, 8, 12, 16, 20, 24, 32, 40, 48, 64, 96 px. The report itself uses a 12-column grid with a 16 px gutter; use that as the alignment reference, not a reason to redraw the project owner's composition.
...
- Retain attribution: Punchlist contributors, Product Designer, github.com/xenstalker02/punchlist. Keep the public posture clear: Punchlist v0.1 is production-ready within its declared capabilities.
...
```text
Inspect this existing Figma frame first: [PASTE the project owner'S APPROVED FIGMA FRAME URL HERE]
